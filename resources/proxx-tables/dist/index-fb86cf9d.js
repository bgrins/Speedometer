define(['exports', './bind-2f0f08bc', './comlink-3caaf381', './streams-c0bf06d5'], function (exports, bind, comlink, streams) { 'use strict';
    ...
    class LitService {
        ...
        constructor(stateService) {
            ...
            this._table = document.getElementById("board");
            if (this._table) {
        ...
        render(state) {
            ...
            let rowCount = 0;
            render(html `
        ${repeat(state.grid, row => rowCount++, (row, rowId) => html `
            <tr>
              ${repeat(row, cell => cell.id, (cell, cellId) => html `
                    <td>
                      <button
                        row=${rowId}
                        col=${cellId}
    ...
    bind.__decorate([
        bind.bind
    ], LitService.prototype, "onUnrevealedClick", null);

    exports['default'] = LitService;

});
//# sourceMappingURL=index-fb86cf9d.js.map
