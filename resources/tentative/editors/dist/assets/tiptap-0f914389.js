import { k as keyName, b as base, t as text, d as text$1 } from "./index.es-b78de652.js";
...
function editor(element, value) {
  ...
  return {
    ...
    setValue(value2) {
      editor2.commands.setContent(value2);
      element.scrollTop = 0;
    },
    format(on) {
      editor2.commands.selectAll();
      if (on) {
        editor2.chain().focus().setBold().run();
      } else {
        editor2.chain().focus().unsetBold().run();
      }
