...
*/ self.sqlite3Worker1Promiser = function callee(config = callee.defaultConfig) {
    ...
    config.worker.onmessage = function(ev) {
        ...
        if (!msgHandler) {
            if (ev && "sqlite3-api" === ev.type && "worker1-ready" === ev.result) {
                /*fired one time when the Worker1 API initializes*/ if (config.onready) config.onready();
                return;
            }
    ...
    return function() {
        ...
        else if (2 === arguments.length) msg = {
            type: arguments[0],
            args: arguments[1]
        };
        else toss("Invalid arugments for sqlite3Worker1Promiser()-created factory.");
...
self.sqlite3Worker1Promiser.defaultConfig = {
    worker: (function() {
        ...
        //console.warn("promiser currentScript, theJs =",this.currentScript,theJs);
            ...
            if (urlParams.has("sqlite3.dir")) theJs = urlParams.get("sqlite3.dir") + "/" + theJs;
        }
...
//# sourceMappingURL=index.deb954e0.js.map
